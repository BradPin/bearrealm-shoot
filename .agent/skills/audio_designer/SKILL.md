...
4. **Registry**: Log all created audio assets into `.agent/asset_registry/audio.csv`.

## Pre-requisites
* Before generating audio, ALWAYS consult `.agent/design/vibe/master_audio_prompt.md` for genre and mixing guidelines.
* Check `.agent/asset_registry/audio.csv` to ensure you don't duplicate existing sounds.